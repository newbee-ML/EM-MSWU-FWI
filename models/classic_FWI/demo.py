...
nx = 751
dx = 4.0
v_true = torch.from_file('data/velocity_models/demo_data/marmousi.bin',
...
observed_data = (
    torch.from_file('data/velocity_models/demo_data/marmousi_data.bin',
...
ax[2].set_title("True")
plt.tight_layout()
plt.savefig('data/velocity_models/demo_data/example_simple_fwi.jpg')
...
ax[2].set_title("True")
plt.tight_layout()
plt.savefig('data/velocity_models/demo_data/example_increasing_freq_fwi.jpg')