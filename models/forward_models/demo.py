...
nx = 751
dx = 4.0
v = torch.from_file('data/velocity_models/demo_data/marmousi.bin',
...
plt.tight_layout()
plt.savefig('data/velocity_models/demo_data/example_forward_model.jpg')

receiver_amplitudes.cpu().numpy().tofile('data/velocity_models/demo_data/marmousi_data.bin')